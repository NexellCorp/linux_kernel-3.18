...
#define IRQ_UART1				(IRQ_OFFSET +  6) 	// pl01115_Uart_modem
#define IRQ_UART0				(IRQ_OFFSET +  7) 	// UART0_MODULE
#define IRQ_UART2				(IRQ_OFFSET +  8) 	// UART1_MODULE
#define IRQ_UART3				(IRQ_OFFSET +  9) 	// pl01115_Uart_nodma0
#define IRQ_UART4				(IRQ_OFFSET + 10)	// pl01115_Uart_nodma1
#define IRQ_UART5				(IRQ_OFFSET + 11)	// pl01115_Uart_nodma2
