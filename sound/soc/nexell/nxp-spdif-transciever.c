...
static struct snd_soc_dai_link spdiftx_dai_link = {
	...
	.codec_name 	= "0.spdif-dit",			/* spidf_transciever.c */
	.symmetric_rates = 1,
};
...
#ifdef CONFIG_OF
static const struct of_device_id nxp_spdiftx_match[] = {
	{ .compatible = "nexell,spdif-transciever" },
	{},
};
MODULE_DEVICE_TABLE(of, nxp_spdiftx_match);
#else
#define nxp_spdiftx_match NULL
#endif
...
static struct platform_driver spdiftx_driver = {
	.driver		= {
        ...
        .of_match_table = of_match_ptr(nxp_spdiftx_match),
	},
	.probe		= spdiftx_probe,
