...
//TODO
#if 1
extern void		nxp_soc_peri_reset_enter(int id);
extern void		nxp_soc_peri_reset_exit(int id);
extern void		nxp_soc_peri_reset_set(int id);
extern int			nxp_soc_peri_reset_status(int id);	/* 1: power on, 0: power down */
#endif
