...
static int  resc_prepare(struct disp_process_dev *pdev)
{
	...
	pr_debug("%s: OUT (x=%4d, hfp=%3d, hbp=%3d, hsw=%3d), (y=%4d, vfp=%3d, vbp=%3d, vsw=%3d)\n",
